...
Record.create!(collection_id: collection.id, name: "The Non-Designer's Design Book", x: 3739.2, y: -64.6, width: 490, height: 700, color: "#626d69", angle: 0, scale: 0.08658, src: "503.jpg")
Record.create!(collection_id: collection.id, name: "Presentation Zen", x: 3784.4, y: -62.9, width: 410, height: 500, color: "#7480ab", angle: 0, scale: 0.0014, src: "504.jpg")
...
Record.create!(collection_id: collection.id, name: "QuickFits Rails application", x: 3982.6, y: -672.9, width: 1428, height: 1230, color: "#797889", angle: -0.093, scale: 0.04205, src: "203.jpg")
