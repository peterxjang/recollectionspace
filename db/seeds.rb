...
User.create!(first_name: "Peter", last_name: "Jang", username: "peterxjang", email: "peter@email.com", password: "password", src: "https://res.cloudinary.com/recollectionspace/image/upload/v1558929196/users/peterxjang.jpg", color: "#48474e", width: 1200, height: 800)
User.create!(first_name: "Test", last_name: "Testerson", username: "test", email: "test@email.com", password: "password", src: "https://res.cloudinary.com/recollectionspace/image/upload/v1558937260/users/test.jpg", color: "#396a6a", width: 1200, height: 800)
User.create!(first_name: "Saron", last_name: "Yitbarek", username: "saron", email: "saron@email.com", password: "password", src: "https://res.cloudinary.com/recollectionspace/image/upload/v1558937048/users/saron.jpg", color: "#584d3e", width: 1200, height: 853)
