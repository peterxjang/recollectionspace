...
import ModalNewRecord from "src/components/modal-new-record";
import ModalNewFollow from "src/components/modal-new-follow";
import ModalNewUserCollection from "src/components/modal-new-user-collection";
import ModalNewSession from "src/components/modal-new-session";
import ModalNewUser from "src/components/modal-new-user";
import ModalEdit from "src/components/modal-edit";
...
const Modal = {
  ...
  setErrors: function (errors) {
    if (this.currentModal && this.currentModal.$errors) {
      ...
      this.currentModal.$errors.innerHTML = errors.map((error) => `<li>${error}</li>`).join("");
